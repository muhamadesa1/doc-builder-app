...
export default function MaintenanceEditor() {
  const [formData, setFormData] = useState({
    ...
    jamSelesai: "",
    issueType: "",
    tujuanKunjungan: "Maintenance Lokasi",
    ...
    asset: "",
    picParkee: "",
    picCp: "", // Nama Terang Partner
    jabatanCp: "Car Park Manager", // Jabatan Partner
  });
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm tracking-tight text-slate-700 dark:text-slate-200">
                Berita Acara <span className="font-bold text-indigo-600 dark:text-indigo-400">Maintenance</span>
              </span>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden z-10">
        ...
        <div className="w-full md:w-5/12 p-6 overflow-y-auto border-r border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md print:hidden space-y-6">
          ...
          <div className="space-y-5 text-sm">
            {/* Section 1: Partner dengan Search Inisial */}
            <div className="p-4 bg-indigo-50/50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/50 rounded-2xl space-y-2">
              ...
              />
              <datalist id="partner-list-maint">
            ...
            {/* Section 3: Detail Maintenance */}
            <div className="p-4 bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800 rounded-2xl space-y-4">
              <h3 className="font-bold text-xs uppercase tracking-wider text-slate-400">Detail &amp; Tindakan</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-3 border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-sm outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm"
                  >
                    <option value="Maintenance Lokasi">Maintenance Lokasi</option>
            ...
            <div>
              ...
              <div className="space-y-2.5 leading-relaxed">
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex items-center gap-8">
                    <button type="button" onClick={() => toggleSelect("tujuanKunjungan", "Maintenance Lokasi")} className="flex items-center gap-2">
                      <div className={`w-3.5 h-3.5 border border-slate-800 ${formData.tujuanKunjungan === "Maintenance Lokasi" ? "bg-black" : "bg-white"}`}></div>
                      <span>Maintenance Lokasi</span>
                    </button>
                ...
                <div className="flex pt-1"><span className="w-40 font-semibold">Tindakan</span><span className="w-6 text-center">:</span><span className="flex-1 whitespace-pre-wrap">{formData.tindakan}</span></div>
